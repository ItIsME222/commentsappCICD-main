...
public class CommentsDAO {
    ...
    private void initialData() {
        ...
        AppComment comment1 = new AppComment(1, "Alice", "This is a great day to talk about life.", null);
        AppComment comment2 = new AppComment(2, "Bob", "I agree with Alice!", null);
        AppComment comment3 = new AppComment(3, "Charlie", "I feel like coding today.", null);
    ...
    public void addComment(String author, String content) {
        AppComment newComment = new AppComment(nextId++, author, content, null);
